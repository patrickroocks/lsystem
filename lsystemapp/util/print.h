...
inline QString printImpl(const qint8   & val) { return QString::number(val); }
inline QString printImpl(const qint16  & val) { return QString::number(val); }
inline QString printImpl(const qint32  & val) { return QString::number(val); }
inline QString printImpl(const qint64  & val) { return QString::number(val); }
inline QString printImpl(const quint8  & val) { return QString::number(val); }
inline QString printImpl(const quint16 & val) { return QString::number(val); }
inline QString printImpl(const quint32 & val) { return QString::number(val); }
inline QString printImpl(const quint64 & val) { return QString::number(val); }
inline QString printImpl(const float   & val) { return QString::number(val); }
inline QString printImpl(const double  & val) { return QString::number(val); }
...
{
	if constexpr (sizeof...(Params) == 0) return str;
	else {
